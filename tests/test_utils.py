...
class TestLLMResponse:
    ...
    def test_response_creation(self):
        ...
        response = LLMResponse(text="Hello, world!", usage=usage, stop_reason="stop")
    ...
    def test_response_without_stop_reason(self):
        ...
        usage = {"input_tokens": 10, "output_tokens": 20, "total_tokens": 30}
        response = LLMResponse(text="Hello!", usage=usage)
        assert response.stop_reason is None

    def test_response_json_serialization(self):
        """Test that response can be serialized to JSON."""
        usage = {"input_tokens": 10, "output_tokens": 20, "total_tokens": 30}
        response = LLMResponse(text="Test", usage=usage, stop_reason="stop")
...
class TestNormalizeUsage:
    ...
    def test_bedrock_usage_normalization(self):
        ...
        bedrock_usage = {"inputTokens": 10, "outputTokens": 20}
    ...
    def test_ollama_usage_normalization(self):
        ...
        ollama_usage = {"prompt_tokens": 10, "completion_tokens": 20, "total_tokens": 30}
    ...
    def test_generic_usage_normalization(self):
        ...
        generic_usage = {"input_tokens": 5, "output_tokens": 15, "total_tokens": 20}
