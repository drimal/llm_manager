...
class TestLLMFactory:
    ...
    def test_openai_client_creation(self):
        ...
        client = LLMFactory.get_client(provider_name="openai", api_key="test-key")
    ...
    def test_anthropic_client_creation(self):
        ...
        client = LLMFactory.get_client(provider_name="anthropic", api_key="test-key")
    ...
    def test_ollama_client_creation(self):
        ...
        client = LLMFactory.get_client(provider_name="ollama", base_url="http://localhost:11434/v1")
    ...
    def test_custom_system_prompt(self):
        ...
        client = LLMFactory.get_client(
            provider_name="openai", api_key="test-key", system_prompt=custom_prompt
        )
    ...
    def test_unknown_provider_raises_error(self):
        ...
        with pytest.raises(UnknownProviderError):
            LLMFactory.get_client(provider_name="unknown_provider", api_key="test-key")

    def test_unknown_provider_error_message(self):
        """Test that error message lists available providers."""
        with pytest.raises(UnknownProviderError) as exc_info:
            LLMFactory.get_client(provider_name="invalid", api_key="test-key")
